...
import { BsFillClipboard2CheckFill, BsFillBagCheckFill } from "react-icons/bs";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:url"
          content="http://top-persona.kg/views/images/logo192.png"
        ></meta>
          ...
          >
            <div className="d-flex">
              ...
              <div>
                ...
                >
                  3 раза в неделю по 2 ч.15 минут. Скидка предусмотрена!
                </p>
              </div>
            </div>
            <div className="d-flex">
              ...
              >
                <div>
                  <BsFillBagCheckFill size={40} style={{ color: "#478AC9" }} />
                </div>
              </div>
              <div>
                <p
                ...
                >
                  У нас книги и учебный материал включены в стоимость курсов
                </p>
              </div>
            </div>
            ...
            <div className="d-flex">
              ...
              <div>
                ...
                >
                  преподаватели носители немецкого языка прожили более 8 лет в
                  Германии и Австрии;
                </p>
              </div>
            </div>
            <div className="d-flex">
              ...
              <div>
                ...
                >
                  50% от стоимости немецкого языка мы Вам возвращаем по приезду
                  в Германию;
                </p>
              </div>
            </div>
